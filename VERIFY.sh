...
echo "1. Start the FastAPI server: python scripts/run_paper_api.py --host 127.0.0.1 --port 8000"
echo "2. Run the verification script: python scripts/verify_changes.py"
