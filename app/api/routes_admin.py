...
def config(request: Request, response: Response) -> dict[str, Any]:
    ...
    return {
        ...
        "ml_entry_current_model_path": settings.ml_entry_current_model_path,
        "ml_entry_candidate_model_path": settings.ml_entry_candidate_model_path,
        "ml_exit_current_model_path": settings.ml_exit_current_model_path,
        "ml_exit_candidate_model_path": settings.ml_exit_candidate_model_path,
